...
export default function Footer(){
    ...
    return(
        ...
        <div className="powered-by flex justify-center items-center gap-4 mb-1">
            ...
            <img src={viteLogo} className="logo-vite max-w-[20rem] max-h-[20rem] hover:filter-hover" alt="vite logo" />
            </a>
            <a href="https://react.dev" target="_blank">
            <img src={reactLogo} className="logo-react max-w-[10rem] max-h-[10rem] hover:filter-hover" alt="react logo" />
            </a>
            <a href="https://code.visualstudio.com/" target="_blank">
            <img src={vscodeLogo} className="logo-vscode mt-[10rem] max-w-[10rem] max-h-[3rem] mx-auto hover:filter-hover" alt="vscode logo" />
            </a>
            <a href="https://tailwindcss.com/" target="_blank">
            <img src={tailwindLogo} className="logo-tailwind max-w-[3rem] max-h-[3rem] hover:filter-hover" alt="tailwind logo" />
            </a>
            <a href="https://www.linkedin.com/in/john-truong-665225197/" target="_blank">
            <img src={profileLogo} className="logo-profile max-w-[2.5rem] max-h-[2.5rem] hover:filter-hover" alt="profile logo" />
            </a>
        </div>
        <div>
